...
def plot_one(input_path):
    ...
    if n_vis < n_total:
        idx = rng.choice(n_total, n_vis, replace=False)
    else:
    ...
    print(
        ...
        f"total={n_total:,} sampled={n_vis:,} centers={len(centers)}"
    )

    reducer = umap.UMAP(
        n_components=2,
        n_neighbors=min(args.n_neighbors, max(2, len(X) - 1)),
    ...
    plt.title(f"token wid={d.get('wid')} UMAP embeddings and centers")
    plt.tight_layout()
...
if __name__ == "__main__":
    ...
    files = [
        "/Users/taka/Downloads/vis_token_257.pt",
        "/Users/taka/Downloads/vis_token_262.pt",
        "/Users/taka/Downloads/vis_token_284.pt",
        "/Users/taka/Downloads/vis_token_290.pt",
    ]
